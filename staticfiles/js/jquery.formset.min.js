(function (a) {
    a.fn.formset = function (c) {
        var l = a.extend({}, a.fn.formset.defaults, c), i = l.extraClasses.join(" "), j = a(this), b = function (n, m) {
            if (l.extraClasses) {
                n.removeClass(i);
                n.addClass(l.extraClasses[m % l.extraClasses.length])
            }
        }, k = function (p, q, n) {
            var m = new RegExp("(" + q + "-\\d+-)|(^)"), o = q + "-" + n + "-";
            if (p.attr("for")) {
            ...
            m.find("a." + l.deleteCssClass).click(function () {
                var r = a(this).parents("." + l.formCssClass), n = r.find('input:hidden[id $= "-DELETE"]');
                if (n.length) {
                    n.val("on");
                    r.hide()
                } else {
                    r.remove();
                    var o = a("." + l.formCssClass).not(".formset-custom-templates");
        ...
        j.each(function (n) {
            var o = a(this), m = o.find('input:checkbox[id $= "-DELETE"]');
            if (m.length) {
        ...
        if (j.length) {
            ...
            if (l.formTemplate) {
                ...
                h.removeAttr("id").addClass(l.formCssClass).addClass("formset-custom-templates");
            ...
            g.click(function () {
                var n = parseInt(a("#id_" + l.prefix + "-TOTAL_FORMS").val()),
                    o = l.formTemplate.clone(true).removeClass("formset-custom-templates"),
