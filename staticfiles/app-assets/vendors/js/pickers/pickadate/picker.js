...
function PickerConstructor( ELEMENT, NAME, COMPONENT, OPTIONS ) {
    ...
    var
        ...
        // Merge the default classes with the settings_main classes.
        ...
        P = PickerInstance.prototype = {
            ...
            start: function() {
                ...
                // Create a new picker component with the settings_main.
                ...
                // Insert the hidden input as specified in the settings_main.
                if ( SETTINGS.containerHidden ) $( SETTINGS.containerHidden ).append( P._hidden )
                else $ELEMENT.after( P._hidden )


                // Insert the root as specified in the settings_main.
                if ( SETTINGS.container ) $( SETTINGS.container ).append( P.$root )
                else $ELEMENT.after( P.$root )


                // Bind the default component and settings_main events.
                P.on({
