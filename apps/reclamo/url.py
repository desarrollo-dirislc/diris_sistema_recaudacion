...
path('cuentas-contabilidad', Mantenimiento_cuentas_contabilidad.as_view(), name='cuentas-contabilidad'),

path(
    'cuentas-contabilidad/eliminar/<int:pk>/',
    EliminarCuentaContabilidad.as_view(),
    name='eliminar-cuenta-contabilidad'
),



path(
    'servicios/eliminar/<int:pk>/',
    EliminarServicio.as_view(),
    name='eliminar-servicio'
),


path(
    'clasificador-ingreso/eliminar/<int:pk>/',
    EliminarClasificadorIngreso.as_view(),
    name='eliminar-clasificador-ingreso'
),
]
