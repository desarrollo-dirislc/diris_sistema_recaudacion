...
class EntidadReclamoForm_monitoreo(forms.ModelForm):
    ...
    class Meta:
        ...
        fields =['ris','entidad2','distrito','velocidad_inter' ,'anexos', 'tipo_incidencia','fecha_hora_perdida' ,'fecha_hora_reestablecido' ,   'observacion','correo','evidencia','evidencia_2' ,'cod_ticket_gtd']  # Incluye todos los campos del modelo
        widgets = {
        ...
        labels = {
            ...
            'cod_ticket_gtd':'Ticket de incidencia'
         }
