...
-- Tiempo de generación: 01-03-2021 a las 19:44:45
...
--
CREATE DATABASE IF NOT EXISTS `db_reclamos` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `db_reclamos`;
...
CREATE TABLE IF NOT EXISTS `reclamo_administrador_detalleevaluacionanexo1` (
  ...
  `created_ip` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `updated_ip` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `reclamo_entidadreclamo` (`id`, `periodo_declaracion_id`, `tipo_institucion`, `codigo_administrado`, `medio_presentacion`, `codigo_registro`, `tipo_documento_usuario`, `numero_documento_usuario`, `razon_social_usuario`, `nombres_usuario`, `apellido_paterno_usuario`, `apellido_materno_usuario`, `tipo_documento_presenta`, `numero_documento_presenta`, `razon_social_presenta`, `nombres_presenta`, `apellido_paterno_presenta`, `apellido_materno_presenta`, `autorizacion_notificacion_correo`, `correo_presenta`, `domicilio_presenta`, `celular_presenta`, `medio_recepcion_reclamo`, `fecha_reclamo`, `detalle_reclamo`, `servicio_hecho_reclamo`, `competencia_reclamo`, `clasificacion_reclamo_1_id`, `clasificacion_reclamo_2_id`, `clasificacion_reclamo_3_id`, `estado_reclamo`, `codigo_reclamo_primigenio`, `etapa_reclamo`, `tipo_administrado_traslado`, `codigo_administrado_deriva`, `resultado_reclamo`, `motivo_conclusion_anticipada`, `fecha_resultado_reclamo`, `comunicacion_resultado_reclamo`, `fecha_notificacion`, `created_at`, `updated_at`, `created_ip`, `updated_ip`, `entidad_id`, `es_mismo_usuario_afectado`) VALUES
(11, 1, 1, NULL, 1, '123', 1, '45454545', NULL, 'CRISTHIAN IRVING', 'VALENCIA', 'BAZAN', 1, '45454545', NULL, 'CRISTHIAN IRVING', 'VALENCIA', 'BAZAN', 1, NULL, NULL, NULL, 3, '2021-02-12', '45', 5, 1, 2, NULL, NULL, 6, '45', 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-02-24 01:19:27.646949', '2021-02-24 01:21:15.641909', '181.176.106.1', '181.176.106.1', 1, 0),
(12, 1, 1, NULL, 2, '123', 1, '45454545', NULL, 'CRISTHIAN IRVING', 'VALENCIA', 'BAZAN', 1, '45454545', NULL, 'CRISTHIAN IRVING', 'VALENCIA', 'BAZAN', 1, NULL, NULL, NULL, 3, '2021-02-06', '45', 4, 1, 25, NULL, NULL, 5, '23', 2, NULL, NULL, 1, 3, NULL, NULL, NULL, '2021-02-24 13:28:13.852977', '2021-02-24 13:28:13.853011', '181.177.233.38', '181.177.233.38', NULL, 0),
(13, 1, 1, '123', 1, '123', 1, '45454545', NULL, 'CRISTHIAN IRVING', 'VALENCIA', 'BAZAN', 1, '45454545', NULL, 'CRISTHIAN IRVING', 'VALENCIA', 'BAZAN', 1, NULL, NULL, NULL, 4, '2021-02-18', '123', 5, 1, 10, NULL, NULL, 5, '123', 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-02-24 13:29:10.384026', '2021-02-24 13:29:10.384059', '181.177.233.38', '181.177.233.38', NULL, 0),
(14, 1, 1, NULL, 2, '1233', 1, '45454545', NULL, 'CRISTHIAN IRVING', 'VALENCIA', 'BAZAN', 1, '45454545', NULL, 'CRISTHIAN IRVING', 'VALENCIA', 'BAZAN', 1, NULL, NULL, NULL, 2, '2021-02-11', 'ASD', 5, 1, 7, NULL, NULL, 5, '123', 2, NULL, NULL, NULL, NULL, '2021-02-11', NULL, '2021-02-12', '2021-02-24 14:07:47.141829', '2021-02-24 16:54:33.298143', '181.177.233.38', '181.177.233.38', 1, 1),
(15, 1, 1, '00006600', 1, '039-2021', 1, '43862416', NULL, 'RICARDO DANTE', 'POMA', 'FELIPE', 1, '43862416', NULL, 'RICARDO DANTE', 'POMA', 'FELIPE', 0, 'RICARDODAN2306@HOTMAIL.COM', 'SOTO BERMEO N° 233 SAN ROQUE SURCO', '939155306', 1, '2021-01-21', 'DIRIS LIMASUR NO REALIZA ABORDAJE INICIAL Y ABORDAJE SINDROMICO TEMPRANO DE CASO REGISTRADO EN CONTAC CENTER DIA VIERNES 15 DE ENERO, CASO REPORTADO A SUSALUD POR FALTA DE INFORMACION Y NO CONTESTAR TELEFONOS DE CONTAC CENTER INCUMPLIMIENTO EL EQUIPO DE RESPUESTA RAPIDA DE DIRIS LIMASUR ATENCION DENTRO DE LAS 24 HORAS. HOY 21 DE ENERO SIN INFORMACION-SE PIDE SANCIONES POR FALTA DE CONTROL DE FUNCIONARIOS POR DIRECTORA DIRIS LIMA SUR.', 11, 3, 6, 36, 36, 2, NULL, 2, NULL, NULL, 0, NULL, NULL, NULL, NULL, '2021-02-25 20:37:24.125703', '2021-02-25 20:37:24.136620', '201.230.217.121', '201.230.217.121', 1, 1);
...
(1, 'Usuario', 'user', '/setup/usuario/list', 'Usuario', 1, NULL),
(2, 'Reclamos', 'eye', '/reclamo/entidad-reclamo/list', 'Reclamos', 1, NULL),
(3, 'Entidad', 'home', '/setup/entidad/list', 'Entidad', 1, NULL),
(4, 'Evaluación', 'edit', '/evaluacion/list', 'Evaluación', 1, NULL);
...
CREATE TABLE IF NOT EXISTS `setup_periodo` (
  `id` int NOT NULL AUTO_INCREMENT,
  `periodo` varchar(80) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
(1, 'pbkdf2_sha256$216000$k85ho7aRtN7Y$dM7bkvFjbBxNLOOk8Ua345xt/IhgVbwcDpUir3x109M=', '2021-03-01 16:50:01.112639', 1, 'admin', '', '', 'admin@gmail.com', 1, 1, '2021-02-05 20:41:46.000000', '12345678', NULL, 1),
...
ALTER TABLE `reclamo_entidadreclamo`
  ...
  ADD CONSTRAINT `reclamo_entidadrecla_periodo_declaracion__78383397_fk_setup_per` FOREIGN KEY (`periodo_declaracion_id`) REFERENCES `setup_periodo` (`id`),
